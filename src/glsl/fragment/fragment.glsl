...
vec3 palette(in float t) {
  vec3 a = vec3(1.0f, 0.5f, 0.0f);  // brightness (orange center)
  vec3 b = vec3(0.0f, 0.4f, 0.0f);  // contrast (only green varies)
  vec3 c = vec3(0.5f, 0.5f, 0.5f);  // how quickly colors change
  vec3 d = vec3(0.0f, 0.0f, 0.0f);  // location of color picks
